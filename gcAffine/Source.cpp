...
Loader firstObj("firstObj.txt");
Loader secondObj("secondObj.txt");

Model2D model = Model2D(firstObj.vertices(), firstObj.indices());
Model2D model_2 = Model2D(secondObj.vertices(), secondObj.indices());

Model2D models[2] = { model, model_2};
